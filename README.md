...
> 
> В сост аве библиотеки есть готовый пример проекта с тремя координаторами. В нем вы можете посмотреть порядок их создания и использования.
> Проект можно посмотреть на GitHub в папке `SwiftCoordinatorsKitExample`, или установил библиотеку с помощью Swift Package Manager, и посмотреть его в Xcode.
> 
