> Вы можете скачать шаблон проекта, созданного на основе SCK по [этой ссылке](https://github.com/DobbyWanKenoby/SwiftCoordinatorsKit_TemplateApp). Далее произведите установку `SCK` с помощью `Swift PackageManager`.
...
> 
> Вы можете скачать шаблон проекта, использующего SCK по [этой ссылке](https://github.com/DobbyWanKenoby/SwiftCoordinatorsKit_TemplateApp).
> После этого произведите установку SCK в соответствии с данной инструкцией.
>
...
>
>	 Другие менеджеры зависимостейв данный момент не поддерживаются
>
